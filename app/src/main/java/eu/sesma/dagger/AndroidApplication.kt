...
open class AndroidApplication : Application(), ActivityProvider {
    ...
    open fun initKoin() {
        startKoin {
            ...
            modules(listOf(applicationModule, coreModule, mainActivityModule, detailActivityModule, appActivityModule))
        }
    }

    override fun activityProvider() {
        registerActivityLifecycleCallbacks(object : ActivityProvider.ActivityProviderCallbacks {
